...
## 2. SEÇÃO “POR QUE É DIFERENTE” / 3 BLOCOS

### Bloco 1 – Curadoria Inteligente
#### Título
Curadoria Inteligente

#### Texto
Nem todo imóvel é uma boa oportunidade. Antes de recomendar qualquer opção, analisamos preço, localização, potencial de valorização, liquidez e histórico da região.

Você recebe apenas imóveis que realmente fazem sentido para o seu objetivo.

---

### Bloco 2 – Transparência em Tempo Real
#### Título
Transparência em Cada Decisão

#### Texto
Você entende exatamente por que cada imóvel foi selecionado.

Apresentamos comparativos, dados de mercado, tendências de preço e todos os fatores que influenciam a compra ou a venda, para que a decisão seja feita com clareza e segurança.

---

### Bloco 3 – Consultoria de Precisão
#### Título
Consultoria de Precisão

#### Texto
Cada cliente possui um objetivo diferente: morar, investir, vender ou proteger patrimônio.

Por isso, a estratégia é construída de forma personalizada, considerando seu momento, perfil e resultado esperado.
...
### Texto superior
A maioria do mercado tenta vender imóveis.
...
#### Texto
Analisamos o mercado, identificamos distorções de preço, imóveis com maior potencial e oportunidades alinhadas ao seu perfil.

Antes de qualquer visita ou proposta, você já sabe quais opções realmente valem a pena.
...
#### Texto
Cada negociação é acompanhada com atenção à documentação, autorizações, regularidade do imóvel e proteção jurídica.

O objetivo é evitar riscos e garantir uma compra, venda ou gestão patrimonial segura.
...
#### Texto
Seja para vender mais rápido ou investir melhor, trabalhamos com uma estratégia voltada à liquidez.

Preço, posicionamento, apresentação e timing são definidos para aumentar o valor percebido e acelerar resultados.
...
### Título
Para quem esta consultoria é ideal
...
## 7. SEÇÃO DE PROVA / CREDIBILIDADE

### Título
Por que clientes escolhem esse método
...
### Números sugeridos
+X imóveis negociados
+X clientes atendidos
Atuação em Santos e região
Atendimento personalizado do início ao fechamento
...
# Nome das Seções para Organização na Landing Page
